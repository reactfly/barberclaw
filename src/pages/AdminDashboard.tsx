              ...
              {!data.context.shop ? (
                ...
                <>
                  <div className="flex flex-wrap gap-3">
                    <Link
                      to="/admin/calendar"
                      className="gsap-action-btn flex items-center gap-2 rounded-xl bg-lime-400 px-4 py-2.5 text-sm font-bold text-black transition-colors hover:bg-lime-500 shadow-[0_0_15px_rgba(163,230,53,0.15)] hover:scale-105"
                    >
                      <Plus className="h-4 w-4" /> Novo Agendamento
                    </Link>
                    <Link
                      to="/admin/staff"
                      className="gsap-action-btn flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium transition-colors hover:bg-white/10 hover:-translate-y-1"
                    >
                  ...
                  <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="gsap-stagger-card relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent p-6 shadow-xl shadow-black/20 group hover:border-white/20 transition-all cursor-default">
                      <div className="absolute right-0 top-0 p-6 opacity-20 transition-transform group-hover:scale-110 group-hover:rotate-6">
                    ...
                    <div className="gsap-stagger-card relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent p-6 shadow-xl shadow-black/20 group hover:border-white/20 transition-all cursor-default">
                      <div className="absolute right-0 top-0 p-6 opacity-20 transition-transform group-hover:scale-110 group-hover:-rotate-6">
                        <CalendarIcon className="h-20 w-20 text-sky-400" />
                      </div>
                      <div className="relative z-10">
                        <div className="mb-4 flex items-start justify-between">
                    ...
                    <div className="gsap-stagger-card relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent p-6 shadow-xl shadow-black/20 group hover:border-white/20 transition-all cursor-default">
                      <div className="absolute right-0 top-0 p-6 opacity-20 transition-transform group-hover:scale-110 group-hover:rotate-6">
                        <UserPlus className="h-20 w-20 text-purple-400" />
                      </div>
                      <div className="relative z-10">
                        <div className="mb-4 flex items-start justify-between">
                  ...
                  <div className="gsap-stagger-card rounded-3xl border border-white/10 bg-white/[0.02] overflow-hidden shadow-2xl shadow-black/40">
